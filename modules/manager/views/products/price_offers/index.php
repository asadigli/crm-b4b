<div class="breadcrumb-header justify-content-between mb-2">
	<div class="my-auto">
		<div class="d-flex justify-content-between align-items-center">
			<h4 class="content-title mb-0 my-auto"><?= lang("Products price offers") ?></h4>
		</div>
	</div>
</div>
            ...
            <thead>
              <tr>
                ...
                <th style="width:10%" class="border-bottom-0"><?= lang("Entry name") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("Customer") ?></th>
								<th style="width:15%" class="border-bottom-0"><?= lang("Brand") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("Brand code") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("OEM") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("Product name") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("Company name") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("Price offer") ?></th>
								<th style="width:10%" class="border-bottom-0"><?= lang("B4B price") ?></th>
              </tr>
            </thead>
