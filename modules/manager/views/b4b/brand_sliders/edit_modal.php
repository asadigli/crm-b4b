<div class="modal fade" id="sliderEdit" tabindex="-1" aria-labelledby="sliderEditLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="sliderEditLabel"><?= lang("Edit slider") ?></h5>
      ...
      <div class="modal-body">
        <form>
          <div class="row">
             ...
             <div class="col-6">
               <div class="custom-control custom-checkbox">
                  <input type="checkbox" data-role="is-clickable" name="is_clickable" id="is_clickable" checked>
                  <label for="is_clickable"><?= lang("Clickable") ?></label>
                </div>
            </div>
