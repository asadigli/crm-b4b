        ...
        <div data-role="customer-info" data-id="<?= $customer["id"] ?>"  class="card-body">
          <div class="row">
            ...
            <?php if ($customer["monthly_payment_amount"]) : ?>
              <div class="col-4 invoice-title mt-2">
                  <p class="m-0" ><b><?= lang("Monthly purchase amount") ?></b></p>
            ...
            <?php if ($customer["last_payment_date"]) : ?>
              <div class="col-4 invoice-title mt-2">
                  <p class="m-0" ><b><?= lang("Last purchase date") ?></b></p>
            ...
            <?php if ($customer["payment_amount"]) : ?>
              <div class="col-4 invoice-title mt-2">
                  <p class="m-0" ><b><?= lang("Total purchase") ?></b></p>
            ...
            <?php if ($customer["left_amount"]) : ?>
              <div class="col-4 invoice-title mt-2">
                  ...
                  <h5><?= $customer["left_amount"] ? number_format((-1) * $customer["left_amount"],2,",",".") . ($customer["currency"] ? " " . $customer["currency"] : "") : "" ?></h5>
              </div>
            <?php endif; ?>
          </div>
        </div>
