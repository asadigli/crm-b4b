<?php
  $this->metaDesc = "";
  $this->metaKeys = "";
  $this->page_title = lang("Car_models");
	...
	<div class="container">
		<div class="mobile-margin-changer mb-4 mt-5">
			<div class="page-card-header tr-none position-relative">
				<div class="cs_whc_title px-3 py-3 mb-0 d-flex align-items-center justify-content-between">
					<h1><?php echo lang("Car_models"); ?></h1>
				</div>
			</div>
      ...
      <div class="page-card-body mobile-p-0 pt-0">
            ...
            <!-- <input type="text" class="form-control" placeholder="<?php echo lang("Search"); ?>..."> -->
						<select type="text" class="form-control py-3" data-role="brand-years" disabled>
              <option value="">- <?php echo lang("Choose year") ?> -</option>
            </select>
				...
				<div class="container-shadow p-2 load" data-role="model-pg-list" data-brand-id="<?php echo $brand; ?>">
					<div class="cg-list">
						<!-- first -->
						<div class="list-line">
							<ul>
