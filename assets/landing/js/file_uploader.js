...
class Flup {
  constructor(params) {
    ...
    this.title = params.title ? params.title : "Click to upload image";
    this.text = params.text ? params.text : "Maximum " + this.FILE_COUNT_LIMIT + (this.FILE_COUNT_LIMIT > 1 ? " files " : " file") + " can be uploaded";
    this.uploadFiles = [];
    this.init();
  }
