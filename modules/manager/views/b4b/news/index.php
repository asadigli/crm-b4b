<div class="content-header">
  <div class="row align-items-center">
    ...
    <div class="col-6 d-flex justify-content-end">
      <button type="button" data-bs-toggle="modal" data-bs-target="#newsAdd" data-role="open-add-news" class="btn btn-primary" name="button"><?= lang("New news") ?></button>
    </div>
  </div>
</div>
          ...
          <table class="table table-bordered table-hover table-striped" style="width:100%;">
            <thead>
              <tr>
                ...
                <th style="width:10%;" ><?= lang("Popup") ?></th>
                <td style="width:7%;"></td>
              </tr>
            </thead>
...
<?php $this->load->view("b4b/news/add_modal.php") ?>
<?php $this->load->view("b4b/news/edit_modal.php") ?>
