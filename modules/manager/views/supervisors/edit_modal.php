<div class="modal fade" id="supervisorEdit" tabindex="-1" aria-labelledby="supervisorEditLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="supervisorEditLabel"><?= lang("Edit supervisor") ?></h5>
