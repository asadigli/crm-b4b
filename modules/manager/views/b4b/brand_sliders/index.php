<div class="content-header">
  <div class="row align-items-center">
    <div class="col-6">
      <h3 class="page-title"><?= lang("Brand sliders") ?></h3>
    </div>
    <div class="col-6 d-flex justify-content-end">
      <button type="button" data-bs-toggle="modal" data-bs-target="#sliderAdd" class="btn btn-primary" name="button"><?= lang("New brand slider") ?></button>
    </div>
  </div>
</div>
          ...
          <table class="table table-bordered table-hover table-striped" style="width:100%;">
            <thead>
              <tr>
                ...
                <th style="width:10%;" ><?= lang("Clickable") ?></th>
                <td style="width:7%;"></td>
              </tr>
            </thead>
...
<?php $this->load->view("b4b/brand_sliders/add_modal.php") ?>
<?php $this->load->view("b4b/brand_sliders/edit_modal.php") ?>
