		 		...
		 		<div class="container">
		 			<div class="row d-flex justify-content-between m-0">
		 				<div class="col-5 d-flex justify-content-center">
		 					<img class="right-img" src="<?= assets("img/logo/footer-line-logo2.png") ?>"
		 						loading="lazy" alt="">
		 				</div>
		 				<div class="col-5 d-flex justify-content-center">
		 					<img class="left-img" src="<?= assets("img/logo/customer.png"); ?>" loading="lazy"
		 						alt="">
		 				</div>
		 			</div>
		 		</div>
		 		...
		 		<div class="top-side-footer">
		 			<div class="row m-0">
		 				...
		 				<div class="col-lg-3 col-md-5 col-sm-none">
		 					<h4><?= lang("Customer_service") ?></h4>
		 					<ul>
		 						<li><a href="<?= path_local("brand-list"); ?>"><?= lang("Brands"); ?></a></li>
		 						<li><a href="<?= path_local("promotions"); ?>"><?= lang("Promotions"); ?></a></li>
		 						<li><a href="<?= path_local("certificates"); ?>"><?= lang("Certificates"); ?></a></li>
		 				...
		 				<div class="col-lg-3 col-md-5 col-sm-none">
		 					...
		 					<ul>
		 						...
		 						<li><a href="<?= path_local("contact"); ?>"><?= lang("Contact_us"); ?></a></li>
		 						<li><a href="<?= path_local("faq"); ?>"><?= lang("FAQ"); ?></a>
		 						</li>
		 					</ul>
		 				</div>
		 				<div class="col-lg-3 col-md-5 col-sm-none">
		 			...
		 			<div class="row m-0">
						...
						<div class="col-md-6 d-flex justify-content-md-end">
							<div class="footer-copyright d-flex align-items-center">
								<?= lang($copyright["text"],["company" => $copyright["company_name"],"link" => $copyright["link"]]) ?>
							</div>
						</div>
		 			</div>
		 		</div>
		 ...
		 <script src="<?= assets("js/jquery/jquery.inputmask.js"); ?>"></script>
		 ...
		 <?= $this->extraJSBefore; ?>
		 <script type="module" src="<?= assets('js/auto.js',$this->config->item("is_production")); ?>"></script>
		 <?= $this->extraJS; ?>
		 <script type="module" src="<?= assets('js/custom.js',$this->config->item("is_production")); ?>"></script>
